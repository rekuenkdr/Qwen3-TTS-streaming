"""Paged KV block allocation with xxhash prefix caching.

Manages a pool of fixed-size blocks (default 256 tokens each).
Blocks are ref-counted and can be shared via prefix cache hits.
"""
...
try:
    ...
    raise ImportError(
        "Paged attention engine requires xxhash. "
